...
// This file contains the GUI menu and also some functions for button actions, including the function that changes the mode

load_json().
global exit is false.

global window_wide is 500. //px
global window_collapsed is 380. //px

global g is gui(window_wide).
...
set g:skin:textfield:margin:h to -5.
...
set style_label_compact:textcolor to rgb(1,1,1).
	...
	set title:style:padding:v to 0.
		global g_logo is title:addlabel("").
		...
		global title_label is title:addlabel("<b>" + ship:name + "</b>").
		...
		global title_hz is title:addlabel("25hz").
		...
		global g_cam is title:addbutton("<b>C</b>").
		set g_cam:style:margin:h to 0.
		set g_cam:style:margin:v to 1.
		set g_cam:style:width to 20.
		set g_cam:style:height to 20.
		set g_cam:style:textcolor to black.
		//set g_cam:visible to false.
		
		
		global g_focus is title:addbutton("<b>F</b>").
		set g_focus:style:margin:h to 0.
		set g_focus:style:margin:v to 1.
		set g_focus:style:width to 20.
		set g_focus:style:height to 20.
		set g_focus:style:textcolor to black.
		set g_focus:onclick to { kuniverse:forceactive(ship). set title_label:style:textcolor to rgb(0.2,1,0.3). }.
		
		
		
		global g_hide is title:addbutton("_").
		...
		global g_close is title:addbutton("<b>X</b>").
	...
	global box_all is g:addvlayout().
	...
	set box_all:style:margin:h to 0.
		...
		global top_box is box_all:addhlayout().
		//set top_box:style:margin:bottom to 4.
			global tab_box is top_box:addhlayout().
			...
			//set tab_box:style:padding:h to 0.
				...
				global tab_options is tab_box:addbutton("Options").
			...
			global toggles_box is top_box:addhlayout().
			set toggles_box:style:width to 160.
			set toggles_box:style:padding:h to 0.
				global b_log is toggles_box:addbutton("Log ").
				...
				global b_readouts is toggles_box:addbutton("Stats").
		...
		// ### Middle box (menu , mode info, stats) ###
		// >>
		...
		set box_main:style:height to 260.
			...
			set box_left:onRadioChange to selectMode@.
				global mode_label is box_left:addlabel("<b>Modes</b>").
				...
				global r_landing is box_left:addradiobutton("Landing",false).
				set r_landing:style to skin_radio.
				global r_hover is box_left:addradiobutton("Hover",false).
				set r_hover:style to skin_radio.
				global r_free is box_left:addradiobutton("Free",false).
				set r_free:style to skin_radio.
				global r_bookmark is box_left:addradiobutton("Bookmark",false).
				set r_bookmark:style to skin_radio.
				global r_pos is box_left:addradiobutton("Go To",true).
				set r_pos:style to skin_radio.
				global r_follow is box_left:addradiobutton("Follow",false).
				set r_follow:style to skin_radio.
				global r_patrol is box_left:addradiobutton("Patrol",false).
				set r_patrol:style to skin_radio.
				global r_race is box_left:addradiobutton("Race",false).
				set r_race:style to skin_radio.

				
				box_left:addspacing(-1).
				
				global b_docking is box_left:addbutton("Dock").
				...
				//set b_docking:onclick to { brakes on. }.
			//<<	
				
				
			global box_center is box_main:addvbox().
			...
			//set box_center:style:bg to "gui/terminal_on.png".
				...
				//>> ### Mode specific menus
				global stack_landing is box_center:addstack().
					global box_landing is stack_landing:addvlayout().
						box_landing:addlabel("Cancelling velocity and landing..").
						box_landing:addspacing(-1).
				
				global stack_hover is box_center:addstack().
					global box_hover is stack_hover:addvlayout().
						box_hover:addlabel("Maintaining height above ground..").
						box_hover:addspacing(-1).
				
				global stack_free is box_center:addstack().
					global box_free is stack_free:addvlayout().
						box_free:addlabel("FLY-BY-WIRE").
						box_free:addlabel("[WASD] to steer").
						
						global box_free_speed is box_free:addhlayout().
							global g_free_speed_label is box_free_speed:addlabel("Speed").
							set g_free_speed_label:style to style_label_compact.
							global g_free_speed_label_val is box_free_speed:addlabel("52 m/s").
							set g_free_speed_label_val:style to style_label_compact_val.
							
						global box_free_heading is box_free:addhlayout().
							global g_free_heading_label is box_free_heading:addlabel("Heading").
							set g_free_heading_label:style to style_label_compact.
							global g_free_heading_label_val is box_free_heading:addlabel("275").
							set g_free_heading_label_val:style to style_label_compact_val.
						box_free:addspacing(-1).
				
				global stack_bookmark is box_center:addstack().
					global box_bookmark is stack_bookmark:addvlayout().
						box_bookmark:addlabel("Bookmark").
						
						global dropdown_bookmark is box_bookmark:addpopupmenu().
				...
				global stack_pos is box_center:addstack().
					global box_pos is stack_pos:addvlayout().
						box_pos:addlabel("[W] North").
						box_pos:addlabel("[A] West").
						box_pos:addlabel("[S] South").
						box_pos:addlabel("[D] East").
						box_pos:addspacing(10).
						global g_pos_lat is box_pos:addlabel("Latitude: ").
						global g_pos_lng is box_pos:addlabel("Distance: ").
						box_pos:addspacing(10).
						global g_pos_distance is box_pos:addlabel("Distance: ").
						global g_pos_hdg is box_pos:addlabel("Heading: ").
						box_pos:addspacing(-1).
				
				global stack_follow is box_center:addstack().
					global box_follow is stack_follow:addvlayout().
						global box_follow_dropdown is box_follow:addhlayout().
						...
						global box_target_distance is box_follow:addhlayout().
							global g_target_distance_label is box_target_distance:addlabel("Distance").
							set g_target_distance_label:style to style_label_compact.
							global g_target_distance_label_val is box_target_distance:addlabel("").
							set g_target_distance_label_val:style to style_label_compact_val.
						
						box_follow:addlabel("Follow distance:").
						global b_follow_dist is box_follow:addhlayout().
							global g_follow_dist is b_follow_dist:addhslider(0,0,100).
							set g_follow_dist:style:width to 145.
							global g_follow_dist_val is b_follow_dist:addlabel("0m").
						...
						global b_circling is box_follow:addhlayout().
							global g_circling is b_circling:addhslider(0,0,50).
							set g_circling:style:width to 145.
							global g_circling_val is b_circling:addlabel("0m/s").
				...
				global stack_patrol is box_center:addstack().
					global box_patrol is stack_patrol:addvlayout().
						box_patrol:addlabel("Patrolling randomly").
						
						box_patrol:addlabel("Radius:").
						global b_patrol_radius is box_patrol:addhlayout().
							global g_patrol_radius is b_patrol_radius:addhslider(0,0,500).
							set g_patrol_radius:style:width to 140.
							global g_patrol_radius_val is b_patrol_radius:addlabel("0m").
						...
						global b_patrol_speed is box_patrol:addhlayout().
							global g_patrol_speed is b_patrol_speed:addhslider(0,0,100).
							set g_patrol_speed:style:width to 140.
							global g_patrol_speed_val is b_patrol_speed:addlabel("0m/s").
				...
				global stack_race is box_center:addstack().
					global box_race is stack_race:addvlayout().
						box_race:addlabel("RACE").
						box_race:addspacing(10).
						global g_race_gate is box_race:addlabel("Gate ").
						global g_race_gatespeed is box_race:addlabel("Speedlimit:").
						box_race:addspacing(10).
						global g_race_laptime is box_race:addlabel("Lap time:").
				...
				global stack_options is box_center:addstack().
					...
					set box_options:style:margin:h to 0.
						...
						global b_force_dock is box_options:addcheckbox("Stay docked",false).
							set b_force_dock:style:fontsize to 12.
							if forceDock set b_force_dock:pressed to true.
							set b_force_dock:ontoggle to { parameter val. set forceDock to val. }.
						global b_auto_land is box_options:addcheckbox("Land on very low fuel",false).
							set b_auto_land:style:fontsize to 12.
							if autoLand set b_auto_land:pressed to true.
						...
						global b_vd_terrain is box_options:addcheckbox("Terrain Prediction",false).
							set b_vd_terrain:style:fontsize to 12.
							set b_vd_terrain:ontoggle to { parameter val. toggleTerVec(val). }.
						
						global b_vd_velocity is box_options:addcheckbox("Velocity",false).
							set b_vd_velocity:style:fontsize to 12.
							set b_vd_velocity:ontoggle to { parameter val. toggleVelVec(val). }.
						global b_vd_thrust is box_options:addcheckbox("Engine Thrust Balance",false).
			...
			//### Box right stats
			global box_right is box_main:addvlayout().
			...
			set box_right:style:width to 160.
				global box_height is box_right:addhlayout().
					global g_height_label to box_height:addlabel("Hover height").
					set g_height_label:style to style_label_compact.
					global g_height_label_val is box_height:addlabel("4.75m").
					set g_height_label_val:style to style_label_compact_val.
					
					//set g_height_label:style:width to 40.
				
				global box_alt is box_right:addhlayout().
					global g_min_alt_label is box_alt:addlabel("Min altitude").
					set g_min_alt_label:style to style_label_compact.
					global g_min_alt is box_alt:addtextfield("").
					set g_min_alt:style:width to 50.
				...
				global box_speedlimit is box_right:addhlayout().
					global g_speedlimit_label is box_speedlimit:addlabel("Speedlimit").
					set g_speedlimit_label:style to style_label_compact.
					global g_speedlimit is box_speedlimit:addtextfield("300").
					set g_speedlimit:style:width to 50.
				...
				global box_height_error is box_right:addhlayout().
					set box_height_error:style:height to 15.
					global g_height_error_label to box_height_error:addlabel("Height error").
					set g_height_error_label:style to style_label_compact.
					global g_height_error_label_val is box_height_error:addlabel("0m").
					set g_height_error_label_val:style to style_label_compact_val.
				global box_radar is box_right:addhlayout().
					set box_radar:style:height to 15.
					global g_radar_label to box_radar:addlabel("Radar height").
					set g_radar_label:style to style_label_compact.
					global g_radar_label_val is box_radar:addlabel("1.23m").
					set g_radar_label_val:style to style_label_compact_val.
				global box_groundspeed is box_right:addhlayout().
					set box_groundspeed:style:height to 15.
					global g_groundpspeed_label to box_groundspeed:addlabel("Ground speed").
					set g_groundpspeed_label:style to style_label_compact.
					global g_groundpspeed_label_val is box_groundspeed:addlabel("12m/s").
					set g_groundpspeed_label_val:style to style_label_compact_val.
				box_right:addspacing(10).
				global box_fuelETA is box_right:addhlayout().
					set box_fuelETA:style:height to 15.
					global g_fuelETA_label to box_fuelETA:addlabel("Fuel duration").
					set g_fuelETA_label:style to style_label_compact.
					global g_fuelETA_label_val is box_fuelETA:addlabel("1000s").
					set g_fuelETA_label_val:style to style_label_compact_val.
				global box_TWR is box_right:addhlayout().
					set box_TWR:style:height to 15.
					global g_TWR_label to box_TWR:addlabel("TWR (local)").
					set g_TWR_label:style to style_label_compact.
					global g_TWR_label_val is box_TWR:addlabel("5.75").
					set g_TWR_label_val:style to style_label_compact_val.
				global box_mass is box_right:addhlayout().
					set box_mass:style:height to 15.
					global g_mass_label to box_mass:addlabel("Drone mass").
					set g_mass_label:style to style_label_compact.
					global g_mass_label_val is box_mass:addlabel("1.756t").
					set g_mass_label_val:style to style_label_compact_val.
				global box_payload is box_right:addhlayout().
					set box_payload:style:height to 15.
					global g_payload_label to box_payload:addlabel("Payload").
					set g_payload_label:style to style_label_compact.
					global g_payload_label_val is box_payload:addlabel("0t").
					set g_payload_label_val:style to style_label_compact_val.
				box_right:addspacing(10).
				
				global button_box is box_right:addvbox().
					global b_cam is button_box:addbutton("Switch cam-mode").
						set b_cam:style:margin:v to 2.
						set b_cam:style:margin:h to 2.
						set b_cam:onclick to { if kuniverse:activevessel = ship toggleCamMode(). }.
					global b_stats is button_box:addbutton("Open vessel stats").
						set b_stats:style:margin:v to 2.
						set b_stats:style:margin:h to 2.
				
				box_right:addspacing(-1).
			
			global g_heightbox is box_main:addvlayout().
		...
		// ### Log ###
		// >>
		global box_log_container is box_all:addvlayout().
		set box_log_container:style:height to 130.
		...
		set box_log_container:style:overflow:right to -18. // ! If overflow is negative, the background image will actually be moved inward, much like padding will move other content inwards. 
			...
			global box_log is box_log_container:addscrollbox().
...
function selectMode { //this is called whenever a new mode is selected in the menu
	...
	if gui_mode = r_landing {
		...
		set freeSpeed to round(groundspeed).
		if freeSpeed < 1 set freeHeading to 90.
		else set freeHeading to headingOf(velocity:surface).
		...
		if not(defined fastestLapTime) global fastestLapTime is 99999999.
		global raceLapStart is -1.
